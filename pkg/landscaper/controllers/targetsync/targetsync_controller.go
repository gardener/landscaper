...
func AddControllerToManagerForTargetSyncs(lsUncachedClient, lsCachedClient, hostUncachedClient, hostCachedClient client.Client,
	logger logging.Logger, mgr manager.Manager) error {

	log := logger.Reconciles("targetSync", "TargetSync")
	ctrl := NewTargetSyncController(lsUncachedClient, lsCachedClient, hostUncachedClient, hostCachedClient,
		log, clusters.NewDefaultSourceClientProvider())
...
func NewTargetSyncController(lsUncachedClient, lsCachedClient, hostUncachedClient, hostCachedClient client.Client,
	logger logging.Logger, p clusters.SourceClientProvider) reconcile.Reconciler {
