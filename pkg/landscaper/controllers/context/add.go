...
func AddControllerToManager(lsUncachedClient, lsCachedClient, hostUncachedClient, hostCachedClient client.Client,
	logger logging.Logger, mgr manager.Manager, config *config.LandscaperConfiguration) error {
	...
	a, err := NewDefaulterController(lsUncachedClient, lsCachedClient, hostUncachedClient, hostCachedClient,
		log,
		mgr.GetScheme(),
