...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*DeployItemTemplate)(nil), (*core.DeployItemTemplate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ExecutionItem_To_core_ExecutionItem(a.(*DeployItemTemplate), b.(*core.DeployItemTemplate), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.DeployItemTemplate)(nil), (*DeployItemTemplate)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ExecutionItem_To_v1alpha1_ExecutionItem(a.(*core.DeployItemTemplate), b.(*DeployItemTemplate), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ExecutionItem_To_core_ExecutionItem(in *DeployItemTemplate, out *core.DeployItemTemplate, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = core.ExecutionType(in.Type)
	out.Configuration = in.Configuration
	return nil
...
func Convert_v1alpha1_ExecutionItem_To_core_ExecutionItem(in *DeployItemTemplate, out *core.DeployItemTemplate, s conversion.Scope) error {
	return autoConvert_v1alpha1_ExecutionItem_To_core_ExecutionItem(in, out, s)
}

func autoConvert_core_ExecutionItem_To_v1alpha1_ExecutionItem(in *core.DeployItemTemplate, out *DeployItemTemplate, s conversion.Scope) error {
	out.Name = in.Name
	out.Type = ExecutionType(in.Type)
	out.Configuration = in.Configuration
	return nil
...
func Convert_core_ExecutionItem_To_v1alpha1_ExecutionItem(in *core.DeployItemTemplate, out *DeployItemTemplate, s conversion.Scope) error {
