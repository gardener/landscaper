...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Executor)(nil), (*core.Executor)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Executor_To_core_Executor(a.(*Executor), b.(*core.Executor), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.Executor)(nil), (*Executor)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_Executor_To_v1alpha1_Executor(a.(*core.Executor), b.(*Executor), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_core_DefinitionSpec_To_v1alpha1_DefinitionSpec(in *core.DefinitionSpec, out *DefinitionSpec, s conversion.Scope) error {
	...
	out.Import = *(*json.RawMessage)(unsafe.Pointer(&in.Import))
	out.Export = *(*json.RawMessage)(unsafe.Pointer(&in.Export))
	out.Executors = *(*[]Executor)(unsafe.Pointer(&in.Executors))
	return nil
}
...
func autoConvert_v1alpha1_Executor_To_core_Executor(in *Executor, out *core.Executor, s conversion.Scope) error {
...
func Convert_v1alpha1_Executor_To_core_Executor(in *Executor, out *core.Executor, s conversion.Scope) error {
	return autoConvert_v1alpha1_Executor_To_core_Executor(in, out, s)
}

func autoConvert_core_Executor_To_v1alpha1_Executor(in *core.Executor, out *Executor, s conversion.Scope) error {
	out.Type = ExecutorType(in.Type)
...
func Convert_core_Executor_To_v1alpha1_Executor(in *core.Executor, out *Executor, s conversion.Scope) error {
