...
func (in *CDRepositoryConfiguration) DeepCopyInto(out *CDRepositoryConfiguration) {
	*out = *in
	if in.Local != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CDRepositoryConfiguration.
func (in *CDRepositoryConfiguration) DeepCopy() *CDRepositoryConfiguration {
	if in == nil {
		return nil
	}
	out := new(CDRepositoryConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LandscaperConfiguration) DeepCopyInto(out *LandscaperConfiguration) {
	*out = *in
	...
	in.ComponentDescriptorRepository.DeepCopyInto(&out.ComponentDescriptorRepository)
	return
}
