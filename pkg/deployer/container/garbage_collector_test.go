...
var _ = Describe("GarbageCollector", func() {
	...
	BeforeEach(func() {
		...
		gc = containerctlr.NewGarbageCollector(testenv.Client, testenv.Client, hostTestEnv.Client, hostTestEnv.Client,
			logger, "test", hostState.Namespace, containerv1alpha1.GarbageCollection{
				Worker:             1,
