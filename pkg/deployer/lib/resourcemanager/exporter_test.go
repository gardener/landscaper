...
var _ = Describe("Exporter", func() {
	...
	It("should export from a existing configmap", func() {
		...
		Expect(state.CreateWithClient(ctx, testenv.Client, cm)).To(Succeed())
	...
	Context("referenced resource", func() {
		It("should export from a referenced configmap", func() {
			...
			Expect(state.CreateWithClient(ctx, testenv.Client, refCm)).To(Succeed())
		...
		It("should export from a referenced secret in an array", func() {
			...
			Expect(state.CreateWithClient(ctx, testenv.Client, sa)).To(Succeed())
			...
			Expect(state.CreateWithClient(ctx, testenv.Client, secret)).To(Succeed())
