...
var _ = Describe("E2E", func() {
	...
	It("should reconcile a deploy item with matching annotation selector", func() {
		...
		ctrl, err := mock.NewController(logging.Discard(), testenv.Client, testenv.Client, testenv.Client, testenv.Client,
			api.LandscaperScheme, record.NewFakeRecorder(1024), mockv1alpha1.Configuration{
