...
func NewLocalClient(log logr.Logger, paths ...string) (TypedClient, error) {
	return &localClient{
		log:   log,
		paths: paths,
	}, nil
...
func (c *localClient) Resolve(ctx context.Context, repoCtx cdv2.RepositoryContext, ref cdv2.ObjectMeta) (*cdv2.ComponentDescriptor, error) {
