...
func ResolveEffectiveComponentDescriptorList(ctx context.Context, client componentrepository.Client, cd cdv2.ComponentDescriptor) (cdv2.ComponentDescriptorList, error) {
