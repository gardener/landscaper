...
// CovertFromComponentDescriptorList converts a component descriptor list to a mapped component descriptor list.
func CovertFromComponentDescriptorList(list cdv2.ComponentDescriptorList) MappedComponentDescriptorList {
