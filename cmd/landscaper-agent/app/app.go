...
func (o *options) run(ctx context.Context) error {
	...
	if err := agent.AddToManager(ctx, o.log,
		o.LsUncachedClient, o.LsCachedClient, o.HostUncachedClient, o.HostCachedClient,
		o.LsMgr, o.HostMgr, o.config, "agent-helm"); err != nil {
