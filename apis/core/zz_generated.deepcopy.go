...
func (in *CriticalProblemsList) DeepCopyInto(out *CriticalProblemsList) {
	*out = *in
	...
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]CriticalProblems, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CriticalProblemsSpec) DeepCopyInto(out *CriticalProblemsSpec) {
	*out = *in
	if in.CriticalProblems != nil {
		in, out := &in.CriticalProblems, &out.CriticalProblems
		*out = make([]CriticalProblem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *CriticalProblemsStatus) DeepCopy() *CriticalProblemsStatus {
	...
	out := new(CriticalProblemsStatus)
	in.DeepCopyInto(out)
	return out
}
