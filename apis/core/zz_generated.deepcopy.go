...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FailedRetrySpec) DeepCopyInto(out *FailedRetrySpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailedRetrySpec.
func (in *FailedRetrySpec) DeepCopy() *FailedRetrySpec {
	if in == nil {
		return nil
	}
	out := new(FailedRetrySpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstallationSpec) DeepCopyInto(out *InstallationSpec) {
	*out = *in
	...
	if in.RetrySpec != nil {
		in, out := &in.RetrySpec, &out.RetrySpec
		*out = new(RetrySpec)
		(*in).DeepCopyInto(*out)
	}
	return
...
func (in *RetrySpec) DeepCopyInto(out *RetrySpec) {
	*out = *in
	if in.SuccessRetrySpec != nil {
		in, out := &in.SuccessRetrySpec, &out.SuccessRetrySpec
		*out = new(SuccessRetrySpec)
		(*in).DeepCopyInto(*out)
	}
	if in.FailedRetrySpec != nil {
		in, out := &in.FailedRetrySpec, &out.FailedRetrySpec
		*out = new(FailedRetrySpec)
		(*in).DeepCopyInto(*out)
	}
	return
...
func (in *RetryStatus) DeepCopyInto(out *RetryStatus) {
	*out = *in
	in.LastRetryTime.DeepCopyInto(&out.LastRetryTime)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SuccessRetrySpec) DeepCopyInto(out *SuccessRetrySpec) {
	*out = *in
	if in.Interval != nil {
		in, out := &in.Interval, &out.Interval
		*out = new(Duration)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SuccessRetrySpec.
func (in *SuccessRetrySpec) DeepCopy() *SuccessRetrySpec {
	if in == nil {
		return nil
	}
	out := new(SuccessRetrySpec)
