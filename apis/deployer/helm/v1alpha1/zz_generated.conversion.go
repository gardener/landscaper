...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ResourceRef)(nil), (*helm.ResourceRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ResourceRef_To_helm_ResourceRef(a.(*ResourceRef), b.(*helm.ResourceRef), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*helm.ResourceRef)(nil), (*ResourceRef)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_helm_ResourceRef_To_v1alpha1_ResourceRef(a.(*helm.ResourceRef), b.(*ResourceRef), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_Chart_To_helm_Chart(in *Chart, out *helm.Chart, s conversion.Scope) error {
	...
	out.ResourceRef = (*helm.ResourceRef)(unsafe.Pointer(in.ResourceRef))
	return nil
}
...
func autoConvert_helm_Chart_To_v1alpha1_Chart(in *helm.Chart, out *Chart, s conversion.Scope) error {
	...
	out.ResourceRef = (*ResourceRef)(unsafe.Pointer(in.ResourceRef))
	return nil
}
...
func autoConvert_v1alpha1_ResourceRef_To_helm_ResourceRef(in *ResourceRef, out *helm.ResourceRef, s conversion.Scope) error {
	out.Key = in.Key
	return nil
}

// Convert_v1alpha1_ResourceRef_To_helm_ResourceRef is an autogenerated conversion function.
func Convert_v1alpha1_ResourceRef_To_helm_ResourceRef(in *ResourceRef, out *helm.ResourceRef, s conversion.Scope) error {
	return autoConvert_v1alpha1_ResourceRef_To_helm_ResourceRef(in, out, s)
}

func autoConvert_helm_ResourceRef_To_v1alpha1_ResourceRef(in *helm.ResourceRef, out *ResourceRef, s conversion.Scope) error {
	out.Key = in.Key
	return nil
}

// Convert_helm_ResourceRef_To_v1alpha1_ResourceRef is an autogenerated conversion function.
func Convert_helm_ResourceRef_To_v1alpha1_ResourceRef(in *helm.ResourceRef, out *ResourceRef, s conversion.Scope) error {
	return autoConvert_helm_ResourceRef_To_v1alpha1_ResourceRef(in, out, s)
}
