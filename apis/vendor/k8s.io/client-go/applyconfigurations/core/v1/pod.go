...
<<<<<<<< HEAD:vendor/k8s.io/client-go/applyconfigurations/networking/v1alpha1/ipaddress.go
package v1alpha1
...
>>>>>>>> master:apis/vendor/k8s.io/client-go/applyconfigurations/core/v1/pod.go
