...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentOverwritesController) DeepCopyInto(out *ComponentOverwritesController) {
	*out = *in
	in.CommonControllerConfig.DeepCopyInto(&out.CommonControllerConfig)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentOverwritesController.
func (in *ComponentOverwritesController) DeepCopy() *ComponentOverwritesController {
	if in == nil {
		return nil
	}
	out := new(ComponentOverwritesController)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Controllers) DeepCopyInto(out *Controllers) {
	*out = *in
	...
	in.ComponentOverwrites.DeepCopyInto(&out.ComponentOverwrites)
