...
require (
	...
	github.com/gardener/landscaper/apis v0.79.0
	github.com/gardener/landscaper/controller-utils v0.79.0
	...
	github.com/open-component-model/ocm v0.3.0-rc.1.0.20230921153454-4fdca213d05a
