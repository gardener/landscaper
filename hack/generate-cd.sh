...
LANDSCAPER_CONTROLLER_IMAGE_REF="${PROVIDER}/${LANDSCAPER_COMPONENT_NAME}/images/landscaper-controller"
LANDSCAPER_WEBHOOKS_SERVER_IMAGE_REF="${PROVIDER}/${LANDSCAPER_COMPONENT_NAME}/images/landscaper-webhooks-server"
LANDSCAPER_AGENT_IMAGE_REF="${PROVIDER}/${LANDSCAPER_COMPONENT_NAME}/images/landscaper-agent"
...
HELM_DEPLOYER_CONTROLLER_IMAGE_REF="${PROVIDER}/${HELM_DEPLOYER_COMPONENT_NAME}/images/helm-deployer-controller"
...
MANIFEST_DEPLOYER_CONTROLLER_IMAGE_REF="${PROVIDER}/${MANIFEST_DEPLOYER_COMPONENT_NAME}/images/manifest-deployer-controller"
...
CONTAINER_DEPLOYER_CONTROLLER_IMAGE_REF="${PROVIDER}/${CONTAINER_DEPLOYER_COMPONENT_NAME}/images/container-deployer-controller"
CONTAINER_DEPLOYER_INIT_IMAGE_REF="${PROVIDER}/${CONTAINER_DEPLOYER_COMPONENT_NAME}/images/container-deployer-init"
CONTAINER_DEPLOYER_WAIT_IMAGE_REF="${PROVIDER}/${CONTAINER_DEPLOYER_COMPONENT_NAME}/images/container-deployer-wait"
...
MOCK_DEPLOYER_CONTROLLER_IMAGE_REF="${PROVIDER}/${MOCK_DEPLOYER_COMPONENT_NAME}/images/mock-deployer-controller"
...
ocm add componentversions --create --file ${COMPONENT_ARCHIVE_PATH} ${SOURCE_PATH}/.landscaper/components.yaml \
  -- VERSION=${EFFECTIVE_VERSION} \
     ...
     PROVIDER=${PROVIDER} \
     LANDSCAPER_CONTROLLER_IMAGE_REF=${LANDSCAPER_CONTROLLER_IMAGE_REF} \
     LANDSCAPER_WEBHOOKS_SERVER_IMAGE_REF=${LANDSCAPER_WEBHOOKS_SERVER_IMAGE_REF} \
     LANDSCAPER_AGENT_IMAGE_REF=${LANDSCAPER_AGENT_IMAGE_REF} \
     ...
     HELM_DEPLOYER_CONTROLLER_IMAGE_REF=${HELM_DEPLOYER_CONTROLLER_IMAGE_REF} \
     MANIFEST_DEPLOYER_CHART_PATH=${MANIFEST_DEPLOYER_CHART_PATH} \
     MANIFEST_DEPLOYER_CONTROLLER_IMAGE_REF=${MANIFEST_DEPLOYER_CONTROLLER_IMAGE_REF} \
     CONTAINER_DEPLOYER_CHART_PATH=${CONTAINER_DEPLOYER_CHART_PATH} \
     CONTAINER_DEPLOYER_CONTROLLER_IMAGE_REF=${CONTAINER_DEPLOYER_CONTROLLER_IMAGE_REF} \
     CONTAINER_DEPLOYER_INIT_IMAGE_REF=${CONTAINER_DEPLOYER_INIT_IMAGE_REF} \
     CONTAINER_DEPLOYER_WAIT_IMAGE_REF=${CONTAINER_DEPLOYER_WAIT_IMAGE_REF} \
     MOCK_DEPLOYER_CHART_PATH=${MOCK_DEPLOYER_CHART_PATH} \
     MOCK_DEPLOYER_CONTROLLER_IMAGE_REF=${MANIFEST_DEPLOYER_CONTROLLER_IMAGE_REF}
