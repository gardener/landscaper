...
bash "${API_PROJECT_ROOT}"/vendor/k8s.io/code-generator/generate-internal-groups.sh \
  ...
  $PROJECT_MOD_ROOT/apis/deployer \
  "helm:v1alpha1 container:v1alpha1 manifest:v1alpha1 manifest:v1alpha2 mock:v1alpha1 healthchecks" \
  --go-header-file "${PROJECT_ROOT}/hack/boilerplate.go.txt"
...
${GOPATH}/bin/openapi-gen "$@" \
  ...
  --input-dirs=github.com/gardener/landscaper/apis/deployer/healthchecks \
