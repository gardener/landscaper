...
type DeployerManagementConfiguration struct {
	...
	// default deployer (helm, container, manifest). If not set, the default repository context for component
	// descriptors and blueprints is used. If this is also not set, the open source repository context is used.
	// +optional
