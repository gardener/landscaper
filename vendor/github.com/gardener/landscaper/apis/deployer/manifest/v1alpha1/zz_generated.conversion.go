...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HPAConfiguration)(nil), (*manifest.HPAConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_HPAConfiguration_To_manifest_HPAConfiguration(a.(*HPAConfiguration), b.(*manifest.HPAConfiguration), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*manifest.HPAConfiguration)(nil), (*HPAConfiguration)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_manifest_HPAConfiguration_To_v1alpha1_HPAConfiguration(a.(*manifest.HPAConfiguration), b.(*HPAConfiguration), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_HPAConfiguration_To_manifest_HPAConfiguration(in *HPAConfiguration, out *manifest.HPAConfiguration, s conversion.Scope) error {
...
func Convert_v1alpha1_HPAConfiguration_To_manifest_HPAConfiguration(in *HPAConfiguration, out *manifest.HPAConfiguration, s conversion.Scope) error {
	return autoConvert_v1alpha1_HPAConfiguration_To_manifest_HPAConfiguration(in, out, s)
}

func autoConvert_manifest_HPAConfiguration_To_v1alpha1_HPAConfiguration(in *manifest.HPAConfiguration, out *HPAConfiguration, s conversion.Scope) error {
	out.MaxReplicas = in.MaxReplicas
	return nil
}
...
func Convert_manifest_HPAConfiguration_To_v1alpha1_HPAConfiguration(in *manifest.HPAConfiguration, out *HPAConfiguration, s conversion.Scope) error {
	return autoConvert_manifest_HPAConfiguration_To_v1alpha1_HPAConfiguration(in, out, s)
}
