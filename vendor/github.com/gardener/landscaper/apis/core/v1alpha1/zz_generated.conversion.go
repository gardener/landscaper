...
func autoConvert_v1alpha1_EnvironmentSpec_To_core_EnvironmentSpec(in *EnvironmentSpec, out *core.EnvironmentSpec, s conversion.Scope) error {
	if err := Convert_v1alpha1_ObjectReference_To_core_ObjectReference(&in.HostTarget, &out.HostTarget, s); err != nil {
		return err
	}
	if err := Convert_v1alpha1_TargetSelector_To_core_TargetSelector(&in.TargetSelector, &out.TargetSelector, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_core_EnvironmentSpec_To_v1alpha1_EnvironmentSpec(in *core.EnvironmentSpec, out *EnvironmentSpec, s conversion.Scope) error {
	if err := Convert_core_ObjectReference_To_v1alpha1_ObjectReference(&in.HostTarget, &out.HostTarget, s); err != nil {
		return err
	}
	if err := Convert_core_TargetSelector_To_v1alpha1_TargetSelector(&in.TargetSelector, &out.TargetSelector, s); err != nil {
		return err
	}
	return nil
}
