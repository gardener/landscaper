...
- `force-reconcile`: This is similar to `reconcile`, but the reconciliation should be 'enforced'. What exactly that means is up to the deployer. It requires the same handling as the reconcile operation annotation.
