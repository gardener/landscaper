...
## Download
# ocm download component eu.gcr.io/gardener-project/landscaper/examples//github.com/gardener/landscaper-examples/guided-tour/subinst-templates/root:1.0.0 -O ./archive-root
# ocm download component eu.gcr.io/gardener-project/landscaper/examples//github.com/gardener/landscaper-examples/guided-tour/subinst-templates/sub:1.0.0 -O ./archive-sub
