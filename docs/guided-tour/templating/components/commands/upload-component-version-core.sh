...
# examples
ocm add resource ${COMPONENT_DIR} --skip-digest-generation --type ociImage --name image-a --version 1.0.0 \
...
# --skip-digest-generation since the images referenced here do not actually exist and are merely added for templating 
# examples
ocm add resource ${COMPONENT_DIR} --skip-digest-generation --type ociImage --name image-b --version 1.0.0 \
