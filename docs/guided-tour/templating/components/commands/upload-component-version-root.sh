...
if [[ $LOCAL_BLUEPRINT == "local" ]]; then
    ...
    ocm add resource ${COMPONENT_DIR} --type blueprint --name blueprint --version 1.0.0 --inputType dir \
    ...
    ocm add resource ${COMPONENT_DIR} --type blueprint --name blueprint --version 1.0.0 --accessType ociArtifact \
        --reference eu.gcr.io/gardener-project/landscaper/examples/blueprints/guided-tour/templating-components:1.0.0
fi

# Add references
ocm add reference ${COMPONENT_DIR} --name core \
    --component github.com/gardener/landscaper-examples/guided-tour/templating-components-core --version 2.0.0
ocm add reference ${COMPONENT_DIR} --name extension \
    --component github.com/gardener/landscaper-examples/guided-tour/templating-components-extension --version 2.0.0
