...
func (in *ContextConfiguration) DeepCopyInto(out *ContextConfiguration) {
	*out = *in
	...
	if in.VerificationSignatures != nil {
		in, out := &in.VerificationSignatures, &out.VerificationSignatures
		*out = make(map[string]VerificationSignature, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *VerificationSignature) DeepCopyInto(out *VerificationSignature) {
	*out = *in
	if in.PublicKeySecretReference != nil {
		in, out := &in.PublicKeySecretReference, &out.PublicKeySecretReference
		*out = new(SecretReference)
		**out = **in
	}
	if in.CaCertificateSecretReference != nil {
		in, out := &in.CaCertificateSecretReference, &out.CaCertificateSecretReference
		*out = new(SecretReference)
		**out = **in
	}
	return
