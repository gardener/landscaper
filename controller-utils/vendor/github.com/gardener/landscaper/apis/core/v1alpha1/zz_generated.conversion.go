...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*HistoryItem)(nil), (*core.HistoryItem)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_HistoryItem_To_core_HistoryItem(a.(*HistoryItem), b.(*core.HistoryItem), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.HistoryItem)(nil), (*HistoryItem)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_HistoryItem_To_v1alpha1_HistoryItem(a.(*core.HistoryItem), b.(*HistoryItem), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_DeployItemStatus_To_core_DeployItemStatus(in *DeployItemStatus, out *core.DeployItemStatus, s conversion.Scope) error {
	...
	out.History = *(*[]core.HistoryItem)(unsafe.Pointer(&in.History))
	return nil
}
...
func autoConvert_core_DeployItemStatus_To_v1alpha1_DeployItemStatus(in *core.DeployItemStatus, out *DeployItemStatus, s conversion.Scope) error {
	...
	out.History = *(*[]HistoryItem)(unsafe.Pointer(&in.History))
	return nil
}
...
func autoConvert_v1alpha1_HistoryItem_To_core_HistoryItem(in *HistoryItem, out *core.HistoryItem, s conversion.Scope) error {
	out.UpdateTime = in.UpdateTime
	out.WriteID = core.WriteID(in.WriteID)
	out.Phase = in.Phase
	return nil
}

// Convert_v1alpha1_HistoryItem_To_core_HistoryItem is an autogenerated conversion function.
func Convert_v1alpha1_HistoryItem_To_core_HistoryItem(in *HistoryItem, out *core.HistoryItem, s conversion.Scope) error {
	return autoConvert_v1alpha1_HistoryItem_To_core_HistoryItem(in, out, s)
}

func autoConvert_core_HistoryItem_To_v1alpha1_HistoryItem(in *core.HistoryItem, out *HistoryItem, s conversion.Scope) error {
	out.UpdateTime = in.UpdateTime
	out.WriteID = WriteID(in.WriteID)
	out.Phase = in.Phase
	return nil
}

// Convert_core_HistoryItem_To_v1alpha1_HistoryItem is an autogenerated conversion function.
func Convert_core_HistoryItem_To_v1alpha1_HistoryItem(in *core.HistoryItem, out *HistoryItem, s conversion.Scope) error {
	return autoConvert_core_HistoryItem_To_v1alpha1_HistoryItem(in, out, s)
}
